...
rollout_trajectories(n_steps = 10000,env = env, max_ep_len = 10000 , actor = SAC.get_deterministic_action, train = False, render = True, collect_trajectories = True, exp_name = experiment_name)
